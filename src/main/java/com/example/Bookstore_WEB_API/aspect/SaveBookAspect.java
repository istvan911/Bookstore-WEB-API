...
public class SaveBookAspect {
    @Before("execution(* com.example.Bookstore_WEB_API.service.BookService.saveBook(..))")
    ...
    @AfterThrowing(value = "execution(* com.example.Bookstore_WEB_API.service.BookService.deleteBookById(com.example.Bookstore_WEB_API.model.Book))", throwing = "exception")
