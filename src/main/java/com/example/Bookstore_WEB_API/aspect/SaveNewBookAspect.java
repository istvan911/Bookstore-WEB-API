...
public class SaveNewBookAspect {
    ...
    @Before("execution(* com.example.Bookstore_WEB_API.service.BookService.deleteBookById(com.example.Bookstore_WEB_API.model.Book))")
    ...
    @AfterReturning(value = "execution(* com.example.Bookstore_WEB_API.service.BookService.deleteBookById(com.example.Bookstore_WEB_API.model.Book))")
    ...
    @AfterThrowing(value = "execution(* com.example.Bookstore_WEB_API.service.BookService.deleteBookById(com.example.Bookstore_WEB_API.model.Book)) && args(book)", throwing = "exception")
